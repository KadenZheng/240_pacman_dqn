...
class GameStateData:
    ...
    def __init__(self, prevState=None):
        ...
        if prevState != None:
            ...
            if hasattr(prevState, 'options'):
                self.options = prevState.options.copy()
    ...
    def deepCopy(self):
        ...
        # Make sure options are copied when deepCopy is called
        if hasattr(self, 'options'):
            state.options = self.options.copy()
        return state
    ...
    def initialize(self, layout, numGhostAgents):
        ...
        # Initialize options dictionary if it doesn't exist
